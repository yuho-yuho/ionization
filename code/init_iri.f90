     ...
     do iAlt = -1, nAlts+2
        do iLon=-1,nLons+2
           do iLat=-1,nLats+2
              ...
              !! set lower boundary values for NO+, yuhong, 10/17/2023
              IRIDensity(iLon,iLat,-1,iNOP_,iBlock) = 2*10**9
              IRIDensity(iLon,iLat,0,iNOP_,iBlock) = 2*10**9
              IRIDensity(iLon,iLat,1,iNOP_,iBlock) = 2*10**9
              write(*,*)"set value for IRI outf(9)"
              !! ---------------------------------------------------
