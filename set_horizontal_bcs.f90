...
subroutine set_horizontal_bcs(iBlock)
  ...
  !-------------------------------------------   
  IDensityS(iLon,:,-1,iNOP_,iBlock) = 10**9
  IDensityS(iLon,:,0,iNOP_,iBlock) = 10**9
  IDensityS(iLon,:,1,iNOP_,iBlock) = 10**1
  write(*,*) "do i change NO+"
...
!                   IDensityS(iLon+2,:,iAlt,iIon,iBlock)
           !! set lower boundary for NO+, yuhong, 10/17/2023
               IDensityS(iLon,:,-1,iNOP_,iBlock) = 10**9
               IDensityS(iLon,:,0,iNOP_,iBlock) = 10**9  
               write(*,*) "set lower boundary"   
           enddo
